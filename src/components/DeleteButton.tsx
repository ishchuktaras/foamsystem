...
export default function DeleteButton({ 
  ...
  // Odstraněn sporný useEffect. Zavření modalu se vyřeší po překreslení (revalidatePath)
  // nebo tím, že formulář úspěšně odeslal data.
          ...
          <div className="bg-[#FEFEFA] rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200 border border-zinc-200">
            ...
            <div className="p-6 pt-0 flex gap-3">
              ...
              <button 
                type="submit"
                onClick={() => {
                  // Volitelné, pokud bychom chtěli modal skrýt ihned
                  // setIsOpen(false) 
                }}
                disabled={pending}
